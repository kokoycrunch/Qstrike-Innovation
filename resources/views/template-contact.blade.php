...
<div class="contact-us">
  ...
  <div class="hero">
    <div class="wrapper">
      <h3 data-aos="fade-right" data-aos-delay="200">{{$contactHeading1}}</h3>
  ...
  <div class="message-form">
    <div class="wrapper">
      <h6 data-aos="fade-down" data-aos-delay="200">{{$formHeading}}</h6>
          {{-- Contact Form --}}
          <div class="wrapper__form">
            @php echo do_shortcode('[contact-form-7 id="6742ea2" title="Contact us"]'); @endphp
          </div>
          {{-- End Contact Form --}}
          <h6 class="text-center pt-4">Are you looking for a CAREER? <a>Click here</a></h6>
    </div>
  </div>
  ...
  <div class="visit-us">
    <div class="wrapper">
        ...
        <h4 class="pt-4" data-aos="fade-down" data-aos-delay="200">{{$visitUsHeading}}</h4>
        <p data-aos="fade-right" data-aos-delay="200">{{$visitUsSubheading}}</p>
